<template>
  <el-container>
    ...
    <el-form
      ...
      <!-- 姓名 -->
      <el-form-item prop="username" label = "姓名" style="width: 50%">
      ...
      <el-form-item prop="phone" label = "联系方式">
        <el-input v-model="UserForm.phone" disabled  style="width: 50%"></el-input>
      </el-form-item>

      <!-- 密码 -->
      <el-form-item prop="password" label = "密码">
        <el-input v-model="UserForm.password" disabled type="password" style="width: 50%"></el-input>
        <el-button @click="dialogFormVisible = true" style="margin-left: 5%">修改</el-button>
      </el-form-item>
      <!-- 按钮 -->
      <el-form-item>&nbsp;&nbsp;
